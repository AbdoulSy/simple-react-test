...
export default function InvestmentForm({
  ...
  return selectedLoan.id ? (
    <Modal isOpen={!!selectedLoan.id} setOpenState={setSelectedLoan}>
      <div>
        ...
        <p>
          Amount Available :{" "}
          <span>
            ({currentUser.CURRENT_CURRENCY.symbol}) {selectedLoan.available}
          </span>
        </p>
        <p>
          Loan ends in{" "}
          {moment().add(selectedLoan.term_remaining, "s").fromNow()}
        </p>
        <form role="form">
