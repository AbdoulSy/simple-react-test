...
describe("Given <CurrentLoanList /> and _LoanData", () => {
    ...
    describe("And the total available to invest is too low", () => {
        beforeEach(async () => {
            render(<CurrentLoanList loanData={_LoanData} setSelectedLoan={setSelectedLoan} totalAvailable={100} />)
    ...
    describe("And the user can invest", () => {
        beforeEach(async () => {
            render(<CurrentLoanList loanData={_LoanData} setSelectedLoan={setSelectedLoan} totalAvailable={10000000} />)
    ...
    describe("And no _loanData", () => {
        beforeEach(async () => {
            render(<CurrentLoanList loanData={[]} setSelectedLoan={setSelectedLoan} totalAvailable={10000000} />)
